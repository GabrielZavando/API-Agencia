export const companyConfig = {
  ...
  services:
    'Desarrollo de sitios web (estáticos y autoadministrables), tiendas online, chatbots con inteligencia artificial, soporte técnico y consultoría en transformación digital.',
  values:
    'Calidad, innovación, mejora continua, confianza y enfoque en resultados.',
