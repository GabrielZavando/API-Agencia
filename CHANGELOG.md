...
## [1.1.0](https://github.com/GabrielZavando/API-Agencia/compare/api-v1.0.0...api-v1.1.0) (2026-03-19)
...
* configure Cloud Run deployment with Workload Identity and Secret ManagerFix/deploy path ([#7](https://github.com/GabrielZavando/API-Agencia/issues/7)) ([f19fd40](https://github.com/GabrielZavando/API-Agencia/commit/f19fd40c45053c95b1e1617793ccf58a4b3cb8fb))
